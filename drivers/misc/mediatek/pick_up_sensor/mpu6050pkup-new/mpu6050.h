...
#define MPU6050_ACCESS_BY_GSE_I2C
    ...
    #define MPU6050_I2C_SLAVE_ADDR		(0xD4)   /* mtk i2c not allow to probe two same address */
#else
...
#define MPU6050_REG_WON_THRES       0x1F
#define MPU6050_REG_LP_ACC_ODR      0x1E
#define MPU6050_REG_INT_STATUS      0x3A
#define MPU6050_REG_DLPF      0x1D
#define MPU6050_REG_ACC_INT_CTL		0x69
...
#define MPU6050_ACTL_LOW            0x80
//#define MPU6050_OPEN_DRAIN          0x40
#define MPU6050_OPEN_DRAIN          0x00

#define MPU6050_LATCH_INT_EN        0x20
#define MPU6050_INT_ANYRD_2CLEAR    0x10

#define MPU6050_WOM_EN				0x40

#define MPU6050_WOM_INT_STATES		0x40
#define MPU6050_ACC_INT_EN			0xC0
// below do not modify
