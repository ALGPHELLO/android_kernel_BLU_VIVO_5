...
#define PFX "S5K3M2_ofilm_sensor"
#define LOG_1 LOG_INF("S5K3M2,OFILM 4LANE\n")
...
#define LOGE(fmt, args...)     pr_debug(PFX "ERROR: [%s] " fmt, __func__, ##args)
...
static kal_bool Is_longExp=0; //shutter 
#define OFILM_S5K3M2_MODULE_ID   0x07
#define BPC_OFF
//extern bool s5k3m2_otp_update(kal_uint16 address);  //modified by chenqiang 
//extern bool s5k3m2_otp_read(kal_uint16 address);  //modified by chenqiang 
extern BYTE get_ofilm_module_id(void);
extern bool s5k3m2_ofilm_read_otp_pdaf_data( kal_uint16 addr, BYTE* data, kal_uint32 size);



static DEFINE_SPINLOCK(imgsensor_drv_lock);
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K3M2_OFILM_SENSOR_ID,
	...
	.ae_ispGain_delay_frame = 2,// 1,   heeh@0509 for ae peak
	...
	//Gionee malp 20160802 modify	for CR01726691 begin
#ifdef ORIGINAL_VERSION
	.isp_driving_current = ISP_DRIVING_6MA,
#else
	.isp_driving_current = ISP_DRIVING_8MA,
#endif
	//Gionee malp 20160802 modify	for CR01726691 end
...
#endif
		//Gionee malp 20160802 modify	for CR01726691 end
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr, //SENSOR_OUTPUT_FORMAT_RAW_Gb add by chenqiang 
	.mclk = 24,
	.mipi_lane_num = SENSOR_MIPI_4_LANE,

    .i2c_addr_table = {0x5A, 0xff},
    .i2c_speed = 400, // i2c read/write speed //wujh modify LSC OTP incorrect
};
...
extern bool s5k3m2_ofilm_otp_read(void);  //modified by chenqiang 
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] =	 
{
	...
	{ 4192, 3104,	  0,  0, 4192, 3104, 1280,   720, 0000, 0000, 1280,  720, 0,	0, 1280,   720},// slim video 
...
static kal_uint16 read_cmos_sensor(kal_uint32 addr)
{
    ...
    if(ret != 0)
		printk("read_cmos_sensor error =%d\n ", ret);
...
static void write_cmos_sensor(kal_uint16 addr, kal_uint16 para)
{
	...
	kdSetI2CSpeed(imgsensor_info.i2c_speed); // Add this func to set i2c speed by each sensor
	ret = iWriteRegI2C(pusendcmd , 4, imgsensor.i2c_write_id);
    if(ret != 0)
		printk("read_cmos_sensor error =%d\n ", ret);
...
//	kal_int16 dummy_line;
	...
	LOG_INF("framerate = %d, min framelength should enable? %d\n", framerate, (int)min_framelength_en);
...
static void write_shutter(kal_uint32 shutter)
{
    ...
    //    kal_uint32 long_shutter=0;
          kal_uint32 Base_FrameLength2=0x116d;//1s
         kal_uint16 Multi=0;  
	kal_uint32  tmp_lines;
	unsigned long flags;
	Base_FrameLength2 = ((kal_uint64)1000000*1000/(((kal_uint64)imgsensor.line_length*1000000 + ((imgsensor.pclk/1000)-1))/(imgsensor.pclk/1000))) - 1;
    printk("nyg shutter %d,Base_FrameLength2 %d\n",shutter,Base_FrameLength2);
	
     // if(imgsensor.sensor_mode ==IMGSENSOR_MODE_CAPTURE)        
        if(shutter>Base_FrameLength2)
           Is_longExp=1;

          if(Is_longExp)
          {  

               Multi=(kal_uint64)shutter/Base_FrameLength2;
			 
		  printk("3m2.Multi=%d \n ", Multi);
		   /*
		   write_cmos_sensor_8(0x0100, 0x00); //auto frame length enable
		   write_cmos_sensor(0x0300,6);
		   write_cmos_sensor(0x0342, 0xffff);
		   write_cmos_sensor(0x0340, (0x117D)*Multi/2);
		   write_cmos_sensor(0x0202, (0x116D)*Multi/2);
		   ...
		   */
		   ...
		   switch(Multi)
		   {
		   		case 1:
				{
					write_cmos_sensor(0x303c, 0x117b);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0x1185);
		   		}
				break;
				case 2:
				{
					write_cmos_sensor(0x303c, 0x22F7);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0x2301);
		   		}
				break;
				case 3:
				{
					write_cmos_sensor(0x303c, 0x3473);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0x347D);
		   		}
				break;
				case 4:
				{
					write_cmos_sensor(0x303c, 0x45EF);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0x45F9);
		   		}
				break;
				case 5:
				{
					write_cmos_sensor(0x303c, 0x576B);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0x5775);
		   		}
				break;
				case 6:
				{
					write_cmos_sensor(0x303c, 0x68E7);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0x68F1);
		   		}
				break;
				case 7:
				{
					write_cmos_sensor(0x303c, 0x7A63);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0x7A6D);
		   		}
				break;
				case 8:
				{
					write_cmos_sensor(0x303c, 0x8BDF);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0x8BE9);
		   		}
				break;
				case 9:
				{
					write_cmos_sensor(0x303c, 0x9D5B);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0x9D65);
		   		}
				break;
				case 10:
				{
					write_cmos_sensor(0x303c, 0xAED7);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0xAEE1);
		   		}
				break;
				case 11:
				{
					write_cmos_sensor(0x303c, 0xC053);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0xC05D);
		   		}
				break;
				case 12:
				{
					write_cmos_sensor(0x303c, 0xD1CF);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0xD1D9);
		   		}
				break;
				case 13:
				{
					write_cmos_sensor(0x303c, 0xE34B);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0xE355);
		   		}
				break;
				case 14:
				{
					write_cmos_sensor(0x303c, 0xF4C7);
					write_cmos_sensor(0x303e, 0x0400);
					write_cmos_sensor(0x3044, 0x0020);
					write_cmos_sensor(0x3046, 0xF4D1);
		   		}
				break;
				default:
				{
    ...
    if(1)
    	{
    		tmp_lines=(imgsensor.pclk/imgsensor.line_length+50)/100;
		if(shutter<tmp_lines)
			{
				spin_lock_irqsave(&imgsensor_drv_lock,flags);
				imgsensor.frame_length=(imgsensor.frame_length+tmp_lines-1)/tmp_lines*tmp_lines;
...
static void sensor_init(void)
{
  ...
  write_cmos_sensor(0xF4A6, 0x00F0);
    write_cmos_sensor(0x3AFA, 0xFBF8); //Update by leewen 21050324
  ...
  write_cmos_sensor(0x3B5C, 0x0006);
    LOG_INF("Exit\n");
  write_cmos_sensor(0x3A92, 0x0807);  //pixel bias 0310
...
static void preview_setting(void)
{
    ...
    write_cmos_sensor(0x6028,0x2000);
    write_cmos_sensor(0x602A,0x14F0);//Pedestal level control
    write_cmos_sensor(0x6F12,0x0000);//0x0040
    write_cmos_sensor(0x6F12,0x0000);//0x0040

    #ifdef BPC_OFF                       
    write_cmos_sensor(0x6028, 0x2000);       
    write_cmos_sensor(0x602A, 0x192C);// BPC block off (01:bypass, 00:enable)   
    write_cmos_sensor(0x6F12, 0x0001);
    ...
    write_cmos_sensor(0x0348,0x106f);//#smiaRegs_rw_frame_timing_y_addr_end	 3131    
    write_cmos_sensor(0x034A,0x0C2f);//#smiaRegs_rw_frame_timing_x_output_size  4208
    ...
    write_cmos_sensor(0x6F12, 0x0000);
    write_cmos_sensor(0x6028,0x4000);//#smiaRegs_rw_frame_timing_x_addr_start	 4     
    write_cmos_sensor(0x0344,0x000C);//#smiaRegs_rw_frame_timing_y_addr_start	 4     
    write_cmos_sensor(0x0346,0x000C);//#smiaRegs_rw_frame_timing_x_addr_end	 4219    
    write_cmos_sensor(0x0348,0x1073);//#smiaRegs_rw_frame_timing_y_addr_end	 3131    
    write_cmos_sensor(0x034A,0x0C33);//#smiaRegs_rw_frame_timing_x_output_size  4208 
    write_cmos_sensor(0x034C,0x0830);
    write_cmos_sensor(0x034E,0x0610);
  #endif
/*
...
write_cmos_sensor(0x0202,0x0200);
write_cmos_sensor(0x0200,0x0400);
write_cmos_sensor_8(0x0B05,0x00);//BPC 01
...
static void normal_capture_setting(void)
{
    ...
    write_cmos_sensor(0x0348,0x106f);//#smiaRegs_rw_frame_timing_y_addr_end	 3131    
    write_cmos_sensor(0x034A,0x0C2f);//#smiaRegs_rw_frame_timing_x_output_size  4208 
    write_cmos_sensor(0x034C,0x1060);//#smiaRegs_rw_frame_timing_y_output_size  3120 
...
write_cmos_sensor(0x0202,0x0200);
write_cmos_sensor(0x0200,0x0400);
write_cmos_sensor_8(0x0B05,0x00);//BPC 0x01
write_cmos_sensor_8(0x0B08,0x00);
write_cmos_sensor_8(0x0B00,0x00);
write_cmos_sensor_8(0x3B3C,0x01);
write_cmos_sensor(0x3B34,0x3030);
...
static void pip_capture_setting(void)
{
    ...
    write_cmos_sensor(0x030C,0x0004);
    write_cmos_sensor(0x030E,0x0056);
    write_cmos_sensor(0x030A,0x0001);
    write_cmos_sensor(0x0308,0x0008);
    write_cmos_sensor(0x0342,0x11F0);
    write_cmos_sensor(0x0340,0x0C74);
...
{
	LOG_INF("E! normal video  currefps:%d\n",currefps);	
	preview_setting();	  //modified by chenqiang 
}
/**********************************************************************************************************************/
...
static void hs_video_setting(void)
{
    ...
    write_cmos_sensor(0x6028,0x4000);//#smiaRegs_rw_frame_timing_x_addr_start	      
    write_cmos_sensor(0x0344,0x0012);//#smiaRegs_rw_frame_timing_y_addr_start	     
    write_cmos_sensor(0x0346,0x0020);//#smiaRegs_rw_frame_timing_x_addr_end	   
    write_cmos_sensor(0x0348,0x106d);//#smiaRegs_rw_frame_timing_y_addr_end	   
    write_cmos_sensor(0x034A,0x0C1f);//#smiaRegs_rw_frame_timing_x_output_size  
    write_cmos_sensor(0x034C,0x02b0);//#smiaRegs_rw_frame_timing_y_output_size  
...
static void slim_video_setting(void)
{
    ...
    write_cmos_sensor(0x6028,0x4000);//#smiaRegs_rw_frame_timing_x_addr_start	      
    write_cmos_sensor(0x0344,0x00c0);//#smiaRegs_rw_frame_timing_y_addr_start	     
    write_cmos_sensor(0x0346,0x01e8);//#smiaRegs_rw_frame_timing_x_addr_end	    
    write_cmos_sensor(0x0348,0x0fbf);//#smiaRegs_rw_frame_timing_y_addr_end	   
    write_cmos_sensor(0x034A,0x0a57);//#smiaRegs_rw_frame_timing_x_output_size 
    write_cmos_sensor(0x034C,0x0500);//#smiaRegs_rw_frame_timing_y_output_size 
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			*sensor_id = read_cmos_sensor(0x6F12);
			...
			LOG_INF("get_imgsensor_id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);   
			if(get_ofilm_module_id() == OFILM_S5K3M2_MODULE_ID) {
            	LOG_INF("Read ofilm s5k3m2 module id successful\n");
				//add by malp for otp read begin   
				if(otp_read_flag == false) {
					LOG_INF("get_imgsensor_id s5k3m2_ofilm_otp_read\n");
					s5k3m2_ofilm_otp_read(); 
					otp_read_flag = true;
				}
				//add by malp for otp read end
				return ERROR_NONE;
            }
             else
            {
        		LOG_INF("Read ofilm s5k3m2 module id faild\n");
                 *sensor_id = 0x00;    
               //  continue ; 
            }
			retry--;
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		...
		LOG_INF("get_imgsensor_id fail, i2c_addr:0x%x, sensor_id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
...
//add by chenqiang
				if(get_ofilm_module_id() == OFILM_S5K3M2_MODULE_ID)
                                {
			                    		LOG_INF("open ofilm s5k3m2 module id successful\n");
				                    	break;  
                                }
                                else
                                {
				                    	LOG_INF("open ofilm s5k3m2 module id fail\n");
                                        sensor_id = 0x00;    
                                   //     continue; 
                                }       
//add by chenqiang 
			...
			LOG_INF("open fail, i2c addr: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
			retry--;
		} while(retry > 0);
		i++;
		if (sensor_id == imgsensor_info.sensor_id)
	...
	sensor_init();
	/*
//add by chenqiang for otp read begin
    if(otp_read_flag == false)
    {
		s5k3m2_ofilm_otp_read(); 
		otp_read_flag = true;
    }
//add by chenqiang for otp read end
*/
	spin_lock(&imgsensor_drv_lock);
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	preview_setting();
	set_mirror_flip(IMAGE_NORMAL); //IMAGE_HV_MIRROR add by chenqiang
	return ERROR_NONE;
}	/*	preview   */
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	{
		printk("[wujh][capture]imgsensor.current_fps is %d\n",imgsensor.current_fps);
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	//chenqiang add for pdaf start
	sensor_info->PDAF_Support = 1;
	//chenqiang add for pdaf end
...
//	UINT16 *feature_data_16=(UINT16 *) feature_para;
    ...
    unsigned long long *feature_data=(unsigned long long *) feature_para;  //add by chenqiang
//    unsigned long long *feature_return_para=(unsigned long long *) feature_para;
	SENSOR_WINSIZE_INFO_STRUCT *wininfo;	
	MSDK_SENSOR_REG_INFO_STRUCT *sensor_reg_data=(MSDK_SENSOR_REG_INFO_STRUCT *) feature_para;

	SET_PD_BLOCK_INFO_T *PDAFinfo;//chenqiang add for PDAF 
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:	 
			LOG_INF("feature_Control imgsensor.pclk = %d,imgsensor.current_fps = %d\n", (int)imgsensor.pclk,(int)imgsensor.current_fps);
		...
		case SENSOR_FEATURE_SET_AUTO_FLICKER_MODE:
			set_auto_flicker_mode((BOOL)*feature_data,*(feature_data+1));
			break;
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			LOG_INF("SENSOR_READ_OTP_PDAF_DATA \n");
			s5k3m2_ofilm_read_otp_pdaf_data((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;
...
UINT32 S5K3M2_OFILM_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
