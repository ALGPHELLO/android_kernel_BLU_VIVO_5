...
#define N2DM_I2C_SLAVE_ADDR		0x32//0x30<-> SD0=GND;0x32<-> SD0=High
...
#define N2DM_REG_CTL_REG5		0x24
#define N2DM_REG_CTL_REG6		0x25
#define Reference_A_RW          0x26
#define Status_REG_A_R          0x27
